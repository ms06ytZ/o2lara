   ...
   <div class="container"> 
    <div class="row"> 
     ...
     <div class="col-lg-4 desc desc-b"> 
      <h4>Project Data</h4> 
      <p> <i class="icon-user"></i> Frank Lampard<br> <i class="icon-tag"></i> Web Design<br> <i class="icon-time"></i> 2013<br> <i class="icon-globe"></i> www.blacktie.co<br> </p> 
     </div> 
    </div> 
   </div>
   <!-- /container --> 
      ...
      <div id="carousel-example-generic" class="carousel slide"> 
       ...
       <div class="carousel-inner"> 
        <div class="item active"> 
         <img alt="" src="../image/item-01.png"> 
        </div> 
        <div class="item"> 
         <img alt="" src="../image/item-02.png"> 
        </div> 
       </div> 
      </div> 
     </div> 
   ...
   <div class="container"> 
    ...
    <div class="row"> 
     ...
     <div class="col-lg-4 col-lg-offset-4"> 
      <a style="font-size:20px;" href="/#portfolio">&lt; <i class="icon-th-large"></i> &gt; </a> 
     </div> 
    </div> 
   </div> 
  </div>
